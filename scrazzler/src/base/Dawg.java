...
//	private static final int END_OF_WORD_BIT_MASK = 0x002000;
	...
	public Dawg(String dawgFile) throws Exception {
	    ...
	    DataInputStream dawgDataFile = new DataInputStream(new BufferedInputStream(new FileInputStream(dawgFile)));
	...
	public Boolean validateString(String toSearchFor) {
		boolean[] found = new boolean[1];
		String upperString = toSearchFor.toUpperCase();
		found[0] = false;
